...
# Fecha:			09-16-2020
# Version			2.0
# Autor:                |FluiD| (master.hdez@gmail.com)
# Colaboración:			Elinostro (ezequiel.hdez@gmail.com)
...
print <<AQUI;
 ...
 dicmake by MasTerSv twitter @MASTERSV19
...
print <<AQUI;
 ===================================================
      Dicmake by MasTerSv ver. 2.0 2020
 ===================================================
 ...
 18.- Concatenar dos diccionarios
 ---------------------------------------------------
 p.-Prefijo : $p
 s.-Sufijo  : $s
 ===================================================
...
####################################################################################################################
####################################### SUBRUTINA concat_dicc ######################################################


sub concat_dicc
{
open (DICCIONARIO1,"$dicc1");
open (DICCIONARIO2,"$dicc2");
@datos2=<DICCIONARIO2>;
@datos=<DICCIONARIO1>;
&generando;
foreach $dicc1 (@datos)
...
####################################################################################################################
####################################### SUBRUTINA define_dicc ######################################################

sub define_dicc
{
#Preguntamos qué diccionarios concatenaremos

print " Nombre del primer diccionario a concatenar: ";
$dicc1 = <STDIN>;
if ($dicc1 eq "\n")
  {
  &define_dicc;
...
if (not open (DICCIONARIO1, "$dicc1"))
  {
      print " No se ha podido abrir el archivo!";
      $null = (<STDIN>);
            &define_dicc;
...
####################################################################################################################
####################################### SUBRUTINA define_dicc2 ######################################################

sub define_dicc2
{
#Preguntamos qué diccionarios concatenaremos

print " Nombre del segundo diccionario a concatenar: ";
$dicc2 = <STDIN>;
if ($dicc2 eq "\n")
  {
  &define_dicc2;
...
if (not open (DICCIONARIO2, "$dicc2"))
  {
      print " No se ha podido abrir el archivo!";
      $null = (<STDIN>);
      &define_dicc2;
